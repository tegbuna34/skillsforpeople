    ...
    <>
      <div className="mx-auto max-w-[820px] px-5 pb-14 pt-16 sm:px-8 md:pt-24 lg:px-16">
        ...
        <p className="text-lg text-navy/75">
          HR teams are being encouraged to use AI but aren&apos;t given the foundation to use it
          for <strong className="font-bold">strategic</strong> work. Skills for People only
          publishes workflows that came from a named practitioner describing something they
          actually built, then turns that into a tool you can run yourself.
        </p>
      </div>

      <div className="mx-auto flex max-w-[820px] flex-col gap-7 px-5 pb-16 sm:px-8 lg:px-16">
        <p className="text-[16.5px] text-navy/75">
          I started this because I kept seeing real HR workflows buried in interviews and talks.
          The specific steps a Talent Acquisition leader or a DEI program manager actually used to
          solve a problem, sitting there in public content that nobody was doing anything with. So
          I started pulling those workflows out and turning each one into a downloadable skill that
          works with Claude or ChatGPT.
        </p>
        <p className="text-[16.5px] text-navy/75">
          Every skill in the library is attributed, with a link back to where it came from. Check
